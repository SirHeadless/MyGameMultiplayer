...
/// Taken From https://www.patrykgalach.com/2019/11/11/implementing-websocket-in-unity/
/// </summary>
public class WsClient
{
    ...
    // Threads
    private System.Threading.Thread receiveThread { get; set; }
    private System.Threading.Thread sendThread { get; set; }
    /// <summary>
    ...
    public WsClient(string serverURL)
    {
        ...
        receiveThread = new System.Threading.Thread(RunReceive);
        receiveThread.Start();
        sendQueue = new BlockingCollection<ArraySegment<byte>>();
        sendThread = new System.Threading.Thread(RunSend);
        sendThread.Start();
    }
    /// <summary>
    ...
    {
        GD.Print("Connecting to: " + serverUri);
        ...
        GD.Print("Connect status: " + ws.State);
    }
    #region [Status]
    /// <summary>
    ...
    {
        GD.Print("WebSocket Message Sender looping.");
    ...
    {
        GD.Print("WebSocket Message Receiver looping.");
        string result;
        while (true)
        {
